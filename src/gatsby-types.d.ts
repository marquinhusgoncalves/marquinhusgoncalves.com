...
type DicasQueryQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly timeToRead: number | null, readonly frontmatter: { readonly title: string | null, readonly slug: string | null } | null } }> } };

type FeaturedPostsQueryVariables = Exact<{ [key: string]: never; }>;


type FeaturedPostsQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly timeToRead: number | null, readonly frontmatter: { readonly title: string | null, readonly slug: string | null } | null, readonly fields: { readonly collection: string | null } | null } }> } };
...
type GetAllTagsQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: { readonly tags: ReadonlyArray<string | null> | null } | null, readonly fields: { readonly collection: string | null } | null } }> } };

type NewsletterEditionQueryQueryVariables = Exact<{
  id: Scalars['String'];
}>;


type NewsletterEditionQueryQuery = { readonly markdownRemark: { readonly timeToRead: number | null, readonly html: string | null, readonly frontmatter: { readonly title: string | null, readonly date: string | null, readonly description: string | null, readonly subject: string | null } | null } | null };

type NewsletterPageQueryQueryVariables = Exact<{ [key: string]: never; }>;


type NewsletterPageQueryQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly timeToRead: number | null, readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null, readonly description: string | null } | null } }> } };
...
type PostQuery = { readonly markdownRemark: { readonly timeToRead: number | null, readonly html: string | null, readonly frontmatter: { readonly title: string | null, readonly slug: string | null, readonly date: string | null, readonly image: string | null } | null } | null };
...
type SearchQueryQuery = { readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly excerpt: string | null, readonly frontmatter: { readonly title: string | null, readonly description: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly date: string | null } | null, readonly fields: { readonly slug: string | null, readonly collection: string | null } | null }> } };
...
type ViagensQueryQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly timeToRead: number | null, readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null } | null } }> } };
...
type GetAllProjectsQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null, readonly tags: ReadonlyArray<string | null> | null } | null } }> } };

type GetAllViagensQueryVariables = Exact<{ [key: string]: never; }>;


type GetAllViagensQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null, readonly tags: ReadonlyArray<string | null> | null } | null } }> } };

type GetAllNewsletterQueryVariables = Exact<{ [key: string]: never; }>;


type GetAllNewsletterQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null } | null } }> } };
